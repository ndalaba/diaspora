...
export default class AuthController extends AbstractController {
  ...
  routes(): Router {
    ...
    this.router.get('/me', authMiddleware, (_: Request, res: Response) =>
      this.successResponse(res, res.locals.user)
    )
