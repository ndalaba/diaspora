...
export type GetAssociationDto = z.infer<typeof GetAssociationSchema> & { user: User }
export type FilterAssociationDto = z.infer<typeof FilterAssociationSchema>
export type CreateAssociationDto = z.infer<typeof CreateAssociationSchema> & { user: User }
export type UpdateAssociationDto = z.infer<typeof UpdateAssociationSchema> & { user: User }
