...
export const CreateUserSchema = z.object({
  ...
  birthYear: z.optional(z.number().min(1930).max((new Date()).getFullYear() - +process.env.MIN_AGE))
});
...
export type CreateUserDto = z.infer<typeof CreateUserSchema> & { user: User | null }
