...
export class migrationTable1695152266883 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`module_user\` ADD CONSTRAINT \`FK_ea29c45e658de59b496022f301e\` FOREIGN KEY (\`association_id\`) REFERENCES \`associations\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE \`module_user\` ADD CONSTRAINT \`FK_220bc9d73fbfc538d278ad730c7\` FOREIGN KEY (\`user_id\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE \`module_user\` ADD CONSTRAINT \`FK_6376ee89570a106e25c0937e612\` FOREIGN KEY (\`module_id\`) REFERENCES \`modules\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`module_user\` DROP FOREIGN KEY \`FK_6376ee89570a106e25c0937e612\``
    )
    await queryRunner.query(
      `ALTER TABLE \`module_user\` DROP FOREIGN KEY \`FK_220bc9d73fbfc538d278ad730c7\``
    )
    await queryRunner.query(
      `ALTER TABLE \`module_user\` DROP FOREIGN KEY \`FK_ea29c45e658de59b496022f301e\``
    )
